...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function bindEvents() {
    ...
    /*
      Important:
      Room No typing/select korle Verification ID ba Homepage Link auto-fill hobe na.
      Ei input listener gulo sudhu suggestion refresh korar jonno.
    */
    if (roomNoInput) {
  ...
  function setupCustomSuggestions() {
    setupSuggestionField({
      ...
      onSelect: (value) => {
        ...
        /*
          Auto-fill removed:
          Room No select korleo Verification ID and Homepage Link blank thakbe.
        */
    ...
    setupSuggestionField({
      ...
      onSelect: (value) => {
        ...
        /*
          Auto-fill removed:
          Verification ID select korleo Homepage Link auto-fill hobe na.
        */
  ...
  function getRoomVerificationSuggestions(query = "") {
    ...
    /*
      Suggestion thakbe.
      Kintu kono value input field-e auto boshbe na.
    */
    if (selectedRoom) {
  ...
  function getRoomPageLinkSuggestions(query = "") {
    ...
    /*
      Priority:
      1. Verification ID field-e user ja type/select koreche, tar upor link suggestion.
      2. Na thakle Room No theke possible link suggestion.
      3. Na thakle default roomOptions.
      Kintu kono case-e auto-fill hobe na.
    */
